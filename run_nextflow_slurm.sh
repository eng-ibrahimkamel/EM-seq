#!/usr/bin/env bash
# EM-seq Pipeline Runner for Slurm
# This script runs the Nextflow pipeline for EM-seq data analysis using Slurm executor
...
# Start execution
log_info "Starting EM-seq Nextflow pipeline execution with Slurm"
...
# Run the nextflow workflow with Slurm profile
log_info "Running Nextflow workflow with Slurm executor"
